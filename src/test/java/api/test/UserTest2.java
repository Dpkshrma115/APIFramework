...
public void testReadUser() {
	...
	Response res = UserEndPoints2.readUser( UserTest2.this.userName());
	res.then()
	.log().all();
	Assert.assertEquals(res.getStatusCode(), 200);
...
public void testUpdateUser() {
	...
	Response updatedRes = UserEndPoints2.updateUser(UserTest2.this.userName(), userPayload);
...
public void testDeleteUser() {
	...
	Response deleteRes = UserEndPoints2.deleteUser( UserTest2.this.userName());
	deleteRes.then()
	.log().all();
